        ...
        with output.open("w", newline="", encoding="utf-8") as handle:
            ...
            for d in decisions:
                writer.writerow({
                    ...
                    "service_period_start": d.service_period_start.isoformat() if d.service_period_start else "",
                    "service_period_end": d.service_period_end.isoformat() if d.service_period_end else "",
